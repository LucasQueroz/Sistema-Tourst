    ...
    $(function() {
        $("#pesquisa").keyup(function() {
            ...
            if (pesquisa != '') {
                ...
                $.post('/www/rodoviagens/controller/pesquisa_editar_viagem.php', dados, function(retorna) {
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                ...
                                <label for="pesquisa">Digite o nome do destino </label>
                                <input class="form-control" name="pesquisa" id="pesquisa" placeholder="Digite aqui o nome do destino...">
