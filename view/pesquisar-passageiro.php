    ...
    $(function() {
        $("#pesquisa").keyup(function() {
            ...
            if (pesquisa != '') {
                ...
                $.post('/www/rodoviagens/controller/pesquisa_cliente.php', dados, function(retorna) {
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                ...
                                <input class="form-control" name="pesquisa" id="pesquisa" placeholder="Digite o nome do passageiro aqui...">
